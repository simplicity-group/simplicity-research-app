            ...
            <div className="border-t border-gray-200 grid grid-cols-2">
                ...
                <div>
                    ...
                    <div className=" px-4 py-3 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                        ...
                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-1 sm:mt-0">{props.someMetric1}</dd>
                    </div>
                    <div className="px-4 py-3 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                        <dt className="text-sm font-medium text-gray-500">Some Metric</dt>
                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-1 sm:mt-0">{props.someMetric2}</dd>
                    </div>
                    </dl>
                </div>
            </div>
