...
const SpecificRequest = () => {
  ...
  return (
    <div className='h-full bg-gray-100'>
      <div className='p-6'>
        <div className='mb-8'>
          <div onClick={() => backToRequests()}
            className='flex h-full justify-center items-center w-56 pl-4 pr-6 pt-2 pb-2 bg-black text-white shadow-sm rounded-md border border-gray-400 hover:shadow-md hover:border-gray-400 hover:bg-gray-900 hover:cursor-pointer'>
